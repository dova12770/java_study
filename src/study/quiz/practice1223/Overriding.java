...
class Square extends Shape {
	...
	public double area() {
		double areaS=this.length*this.length;
		return areaS;
	}
}
...
class Triangle extends Shape {
	...
	public double area() {
		double areaT=this.base*this.height/2.0;
		return areaT;
	}
}
...
class Circle extends Shape {
	...
	public double area() {
//		double areaC=this.radius*this.radius*3.14;
		double areaC=this.radius*this.radius*Math.PI;
		return areaC;
	}
}